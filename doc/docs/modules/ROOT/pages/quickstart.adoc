...
If you don't have APOC installed on your Neo4j instance, you will get errors like this:
...
This last solution will cause every value of attributes affected by this problem to be cast to String.

You will also see a warning in your log letting you know what happened:

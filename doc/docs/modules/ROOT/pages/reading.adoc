 ...
 * <<bookmark-read-node,Node Labels>>
 * <<bookmark-read-rel,Relationship name>>
...
// +--------+----------+--------------------+--------------------+------------+
// |<rel.id>|<rel.type>|            <source>|            <target>|rel.quantity|
// +--------+----------+--------------------+--------------------+------------+
// |       4|    BOUGHT|[fullName -> "Joh...|[name -> "Product...|         240|
// |       5|    BOUGHT|[fullName -> "Jan...|[name -> "Product...|         145|
// +--------+----------+--------------------+--------------------+------------+
----

...
by node labels, by relationship name, and by direct query
--
...
|<<writing.adoc#node-keys,Docs here>>
|``
|Yes for <<writing.adoc#keys-strategy,KEYS>> strategy
...
|<<writing.adoc#node-save-modes,Node Save Mode>>
|`Match`
|No

...
val df = (1 to 10)/* generate your DF */.toDF()

// This is how the Dataframe look like
// +--------+----------+-----------+---------------+---------+---------------+-----------+---------------+-----------+---------+------------+
...
For all the other cases you can use the *KEYS* strategy.
Say you have a Dataframe like this:

TK put table

To write it to Neo4j is enough to specify a list of attributes and
